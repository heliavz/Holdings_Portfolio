...
function AccountDropdown() {
  return (
    <div className="absolute bottom-[72px] left-4 w-[264px] bg-white rounded-[8px] shadow-[0_0_16px_rgba(0,0,0,0.25)] p-3 z-50 transition-all duration-300 animate-fade-in-down">
      {/* Options */}
      ...
      {/* Separator */}
      <div className="w-[232px] h-[0.5px] bg-border mx-auto my-4"></div>
